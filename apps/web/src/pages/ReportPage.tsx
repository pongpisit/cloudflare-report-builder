...
export default function ReportPage({ data, input, onReset, userEmail }: Props) {
  ...
  // Auto-fetch AI summary on mount. Skipped in embedded (scheduled attachment)
  // mode: the summary was generated by the Worker at send time and travels
  // with the file; there is no backend to call and nothing to archive.
